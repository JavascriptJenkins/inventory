    ...
    public String sendShoppingTokenLinkSMS(String phonenumber,
        ...
        try {
            ...
            if (!isDev1) {
                ...
                String smsUrl = baseuri+"/menu5/shop?shoppingtoken=" + encodedSmsToken + "&menuid=" + menuid;

                result = sendDownloadLinkCustomPhoneNumber(phonenumber, smsUrl, isDev1);
            } else {
                String baseuri = env.getProperty("base.qr.domain");
                String smsUrl = baseuri+"/menu5/shop?shoppingtoken=" + shoppingtoken + "&menuid=" + menuid;
                System.out.println("------------------------------------------------------------------------------");
    ...
    public String sendOutCustomerInfoFromConferenceSMS(String phonenumber, CustomerVO customerVO, boolean isDev1){
        ...
        try {
            ...
            if(!isDev1){
                ...
                if(hasphone){
                    String messagetext2 = "Hey "+customerVO.getName()+" it was great to meet you at the conference.  Call or text me anytime!" +
