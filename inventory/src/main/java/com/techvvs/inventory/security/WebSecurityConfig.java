...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.authorizeRequests()
            ...
            .antMatchers(LEGAL_TOS).permitAll()
            .antMatchers(LEGAL_PRIVACY_POLICY).permitAll()
            ...
            .antMatchers(VIDEO_VIDEOS).permitAll()
            ...
            .antMatchers(PHOTO_PRODUCT_33).permitAll()
            .antMatchers(PHOTO_PHOTO).permitAll()
            .antMatchers(PHOTO_PHOTO_33).permitAll()
            .antMatchers(DOCUMENT_PRODUCT).permitAll()
            .antMatchers(DOCUMENT_PRODUCT_33).permitAll()
            .antMatchers(DOCUMENT_DOCUMENTS).permitAll()
            .antMatchers(DOCUMENT_DOCUMENTS_33).permitAll()
            ...
            .antMatchers(KALE_MOVIE_33).permitAll()
            .antMatchers(KALE_MOVIE).permitAll()
            .antMatchers(PAYPAL_JSON_API_1).permitAll()
            .antMatchers(PAYPAL_JSON_API_1_33).permitAll()
            .antMatchers(PAYPAL_RETURN_API_1_33).permitAll()
            .antMatchers(PAYPAL_RETURN_API_1).permitAll()
            .antMatchers(PAYPAL_CANCEL_API_1_33).permitAll()
            .antMatchers(PAYPAL_CANCEL_API_1).permitAll()
